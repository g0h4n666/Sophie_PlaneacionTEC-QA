# Sofia Platform - Documentación de Arquitectura y Archivos

Esta documentación detalla la estructura del código fuente de la plataforma Sofia, orquestador de planeación tecnológica y financiera.
...
Este es el módulo más complejo, dividido en 4 pasos secuenciales de gobernanza.

| Archivo | Responsabilidad |
| :--- | :--- |
| `components/Planning.tsx` | Contenedor principal del flujo de planeación. Orquesta la navegación entre los 4 pasos y gestiona el estado de las iniciativas. |
...
| `components/planning/Step5PressureTest.tsx` | Paso 3: Revisión crítica de coherencia financiera (VPN/I) y checklist de validación. |
| `components/planning/Step6Consolidacion.tsx` | Paso 4: Cierre del ciclo de planeación y preparación para persistencia en SAP. |
...
## 📁 Módulo de Seguimiento 0+n

Gestiona la ejecución real frente a lo planeado.

| Archivo | Responsabilidad |
| :--- | :--- |
| `components/FollowUp.tsx` | Módulo reiniciado para el desarrollo de la nueva lógica de seguimiento 0+n. |
...
---
*Sofia v2.0 - Dirección de Planeación Tecnológica*